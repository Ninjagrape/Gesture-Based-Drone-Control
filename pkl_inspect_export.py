...
PKL_PATH = "gesture_dynamic.pkl"   # change to your file
...
def main():
    ...
    # invert scaling to get original features (what you fed before StandardScaler)
    # standardscaler stores per-feature mean_ and scale_
